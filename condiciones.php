...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top navbar-color">
            <div class="container">
                <!-- LOGO -->
                <a class="navbar-brand" href="index.php"><img class="logo" src="./images/New_Logo_EyC2024-removebg-preview.png" alt="E&C Ingeniería Logo"></a>
    ...
    <!-- Main Content -->
    <main class="content">
        <img src="./images/condiciones1.jpeg" class="img_condiciones" alt="Imagen de condiciones" width="1700" height="2200">
    </main>

    <!-- Footer -->
    <footer id="footer" class="slogan">
        <div class="container footercolor">
            <div class="row text-center text-xs-center text-sm-left text-md-left">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <ul class="list-unstyled quick-links">
                        ...
                        <li><a href="./politicasetica.php"><i class="fa fa-angle-double-right"></i>Política ética</a></li>
                        <li><a href="./politicastratamiento.php"><i class="fa fa-angle-double-right"></i>Política de tratamiento</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <h5>Contactos</h5>
                    <ul class="list-unstyled quick-links">
                        ...
                        <ul class="list-unstyled quick-links">
                            <li style="color: white;"><i class="fa fa-phone"></i>Teléfono: (604) 4480265</li>
                            <li style="color: white;"><i class="fa fa-map-marker"></i>Sede Principal Medellín(Antioquia)</li>
                            <li style="color: white;"><i class="fa fa-map-marker"></i>CALLE 10 SUR 48 - 62 Barrio Aguacatala 2</li>
                        </ul>
                    </ul>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <ul class="list-unstyled list-inline social text-center">
                        ...
                        <li class="list-inline-item"><a href="mailto:info@inspecta.com.co"><i class="fa fa-envelope"></i></a></li>
                    </ul>
                </div>
                <hr class="hr_border">
            </div>    
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 text-center">
                    <p class="h6">&copy; 2024 E&C INGENIERÍA S.A.S. Todos los derechos reservados.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- Scripts -->
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-6gYMZEuPYuDJyw3tFYLUxZmcubih27yKhT6NUXso3lCBmZnoyVV2PKfnTEAghGjc" crossorigin="anonymous"></script>
</body>
</html>
