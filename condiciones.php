        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top navbar-color">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
					...
					<!--<img fetchpriority="high" decoding="async" class="img_politica" alt="" width="1700" height="2200" data-lazy-srcset="./images/condiciones.jpeg">-->
					<img src="./images/condiciones1.jpeg" class="img_condiciones" alt=""width="1700" height="2200">
