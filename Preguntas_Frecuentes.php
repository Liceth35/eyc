    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top navbar-color">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="index.php">
                ...
                <img class="logo" src="./images/New_Logo_EyC2024-removebg-preview.png" alt="Logo">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="trabaja-con-nosotros.php"><strong>TEAM</strong></a></li>

                    <li class="nav-item dropdown">

                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownPoliticas" role="button" data-bs-toggle="dropdown" aria-expanded="false">
