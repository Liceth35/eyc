...
<body>
    ...
    <div class="container my-4 pt-5">
        <div class="row">
            <div class="col-lg-6 text-center">
                <img src="./images/contactos.jpg" class="img-fluid" alt="Contactos Imagen">
            </div>
            <div class="col-lg-6 d-flex align-items-center">
                <h3 class="textcontactanos">"Estamos aquí para ayudarte. Por favor, cuéntanos el motivo por el que nos has contactado."</h3>
            </div>
        </div>
    </div>

    <div class="container my-4 text-contactos">
        <h1>Descubre la Diferencia</h1>
        <div class="row">
            <div class="col text-contactos">
                <h4>
    ...
    <div class="container my-4">
        <div class="row text-contactos">
            <div class="col-sm-4 ">
                <div class="sede">
                    <p class="location"><i class="fa fa-map-marker"></i></p>
                    <p class="text">Nuestra Sede Principal <br>CALLE 10 SUR 48 - 62 Barrio Aguacatala 2</p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="sede">
                    <p class="correo4"><i class="fa fa-envelope"></i></p>
                    <p>Escríbenos al correo: <br>pqr@eyc.com.co</p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="sede">
                    <p class="phone"><i class="fa fa-phone"></i></p>
                    <p class="text">Marca en todo el país al número: <br> (604) 4480265</p>                    
                </div>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-sm-8">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7933.003985667243!2d-75.579361!3d6.197305!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e46827cad8106b7%3A0xe5327b63bd337bbe!2sCl.%2010%20Sur%20%2348-62%2C%20El%20Poblado%2C%20Medell%C3%ADn%2C%20El%20Poblado%2C%20Medell%C3%ADn%2C%20Antioquia!5e0!3m2!1sen!2sco!4v1713360910443!5m2!1sen!2sco" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="mapaGoogle"></iframe>
            </div>
            <div class="col-sm-4">
