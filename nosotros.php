    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top navbar-color">
            <div class="container">
                ...
                <!-- Navbar links -->
                <div class="collapse navbar-collapse nosotros_nav" id="navbarNav">
                    <ul class="navbar-nav ms-auto nosotros_nav">
        ...
        <div class="services_block">
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <img src="./images/certificados-ssl-de-un-año.png" class="img-fluid" alt="Descripción de la imagen 2">
                    </div>
                </div>
                <!-- ROW -->
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <img src="./images/certificados-ssl-de-un-año.png" class="img-fluid" alt="Descripción de la imagen 4">
                    </div>
                </div>
            </div>
        </div>
